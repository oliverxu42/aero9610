...
> The Spacecraft Control Toolbox (SCT) for MATLAB lets users design, analyse, and simulate spacecraft of any complexity.
...
You can run them by typing the following commands in the command line:
...
1. Familiarise yourself with SCT and the functionality it provides. Play around with some more demos to get a better feel for the software.
